...
function createDataForNewTables()
{
    $htlBranches = Db::getInstance()->executes(
        'SELECT p.`id_profile`, hbi.`id` as id_hotel, \'1\' as access FROM htl_branch_info` hbi
...
function updateTables()
{
    return Db::getInstance()->execute(
        'CREATE TABLE IF NOT EXISTS htl_booking_demands_tax` (
        ...
        ALTER TABLE htl_booking_demands`
        ...
        ALTER TABLE htl_room_type_global_demand`
        ...
        CREATE TABLE IF NOT EXISTS htl_access` (
